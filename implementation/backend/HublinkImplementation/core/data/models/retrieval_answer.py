...
<<<<<<< HEAD:implementation/backend/HublinkImplementation/sqa_system/core/data/models/retrieval_answer.py
=======
    extracted_keywords: List[str] = Field(
        default_factory=list,
        description="Keywords extracted while preprocessing the retrieval question.")
>>>>>>> origin/dev:implementation/backend/HublinkImplementation/core/data/models/retrieval_answer.py

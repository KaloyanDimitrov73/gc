...
<<<<<<< HEAD:implementation/backend/HublinkImplementation/sqa_system/core/data/secret_manager.py
...
>>>>>>> origin/dev:implementation/backend/HublinkImplementation/core/data/secret_manager.py

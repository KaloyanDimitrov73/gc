...
from experimentation.experiment_config_builder import ExperimentConfigBuilder
...
def main():
    ...
    results_path = fpm.combine_paths(current_directory, "results_ollama")

...
def main():
    ...
    llm_evaluator_configs_path = fpm.combine_paths(
        fpm.get_parent_directory(current_directory, 3),
        "llm_evaluator_configs.json"
    )
    ...
    exp_config_builder.load_evaluators_from_path(llm_evaluator_configs_path)
    ...
    runner = ExperimentRunner(
        ...
        settings=ExperimentRunnerSettings(
            ...
            weave_project_name="experiment_cross_encoder",
            number_of_workers=4,
